  ...
  return (
    <>
      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <p style={{ fontSize: '14px', lineHeight: 1.85, margin: '0 0 14px' }}>L&apos;abonnement DadUp est proposé au prix de 35,99 € TTC accès complet. Toute modification est notifiée par email au moins 30 jours avant son entrée en vigueur. Le paiement est réalisé par carte bancaire via Stripe. DadUp ne collecte ni ne stocke aucune donnée bancaire. L&apos;abonnement expire automatiquement à son échéance, sans reconduction tacite et sans prélèvement automatique.</p>
