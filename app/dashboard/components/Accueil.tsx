    ...
    <div style={{display:'flex',flexDirection:'column',gap:'16px'}}>
      ...
      {dataR&&(
        <div style={{background:'rgba(184,240,216,0.3)',borderRadius:'20px',padding:'20px 22px',border:'1px solid rgba(13,107,64,0.15)'}}>
          ...
          <p style={{color:'#0A2E1A',fontSize:'16px',fontWeight:800,margin:'0 0 8px'}}>{dataR.doc_titre}</p>
          <p style={{color:'#0D4A2E',fontSize:'14px',lineHeight:1.75,margin:0}}>{dataR.doc}</p>
        </div>
      )}
