...
export default function Accueil({C,dpa,saReelle,joursRestants,prog,tri,idee,missions,missionsChecked,toggleM,nextRdv,nextRdvDate,saveRdv,saveRdvI,dataR,sa,data}:any) {
  return (
    <div style={{display:'flex',flexDirection:'column',gap:'20px'}}>
      ...
      {/* MENTION MÉDICALE */}
      <div style={{ background: '#f0ede8', borderRadius: '12px', padding: '12px 16px', display: 'flex', alignItems: 'center', gap: '10px', marginTop: '16px' }}>
        <span style={{ fontSize: '16px', flexShrink: 0 }}>⚕️</span>
        <p style={{ color: '#6a7585', fontSize: '12px', lineHeight: 1.6, margin: 0 }}>
