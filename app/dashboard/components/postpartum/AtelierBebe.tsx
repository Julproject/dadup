...
const ATELIERS: Atelier[] = [
  {
    ...
    sousTitre: 'Efficace et sans strèss',
    couleur: '#1A4A7A',
    fond: '#E6F0FA',
    etapes: [
      {
        titre: 'Avant de commencer',
        texte: `Prépare tout a portée de main avant de poser bébé : couche propre ouverte, lingettes ou coton eau tiède, crème si besoin. Ne laisse jamais bébé seul sur la table, même une seconde.`,
      },
      {
        titre: 'Ouvrir et nettoyer',
        texte: `Soulève les fesses en tenant les deux chevilles doucement. Replié la couche sale sous les fesses. Nettoie toujours de l'avant vers l'arrière. Chez les garçons : garde une lingette prete sur le penis.`,
      },
      {
        titre: 'Poser la couche propre',
        texte: `Glisse la couche propre sous les fesses. La partie avant remonte sur le ventre. Attaches symetriques sur le devant. Vérifie que les bords aux cuisses sont dépliés vers l'exterieur.`,
      },
      {
        titre: 'Le cordon ombilical',
        texte: `Plie le bord avant de la couche pour ne pas frotter dessus. Il tombe seul entre J5 et J15. Serum physiologique une fois par jour si besoin. Ne pas tirer.`,
      },
      {
    ...
    etapes: [
      {
        ...
        texte: `Bouche grande ouverte sur l'aréole (pas que le mamelon). Lèvres retroussees. Menton appuye contre le sein. Tu entends des déglutitions. Si tu as mal au-delà de 30 secondes : mauvaise prise, détacher et recommencer.`,
      },
      {
        titre: 'Détacher sans douleur',
        texte: `Glisse ton petit doigt dans le coin de sa bouche pour briser la succion, puis ecarte doucement. Recommencer n'est pas un echec.`,
      },
      {
        titre: 'Les positions',
        texte: `Berceau (classique), football (bébé sous le bras, utile après césarienne), allongee (pratique la nuit). Essaie les trois, ton corps trouve sa préférence.`,
      },
      {
        titre: 'Fréquence et duree',
        texte: `8 à 12 tétées par 24h les premieres semaines. Pas de regle de duree : 10 à 40 minutes selon les bébés. Laisser finir un sein avant de proposer l'autre.`,
      },
      {
        titre: 'Ton role',
        texte: `Apporter a boire (elle perd beaucoup de liquide). Créer un environnement calme. Prendre le bébé entre les tétées pour qu'elle récupère. Une consultante en lactation (IBCLC) peut tout changer en une seance.`,
      },
    ],
    ...
    etapes: [
      {
        ...
        texte: `Dans l'ordre : faim, couche, temperature, douleur/coliques, besoin de contact. Si rien de tout ca : portage ou bruit blanc.`,
      },
      {
        titre: 'Reconnaitre le pleur de faim',
        texte: `Rythme regulier qui s'intensifie. Signes avant les pleurs : tourne la tete, ouvre la bouche, mains à la bouche. Reperer ces signaux tot rend la tétée plus facile.`,
      },
      {
        titre: 'Les coliques',
      ...
      {
        titre: 'Quand tu decroches toi',
        texte: `Si tu sens que tu perds le controle : pose bébé en sécurité dans son lit, sors de la chambre, respire 5 minutes. Revenir calme vaut mieux que rester en te forçant.`,
      },
    ],
  ...
  },
  {
    ...
    etapes: [
      {
        titre: 'Départ',
        texte: `Carre de mousseline 120x120 cm en losange. Replié le coin supérieur de 15 cm vers le bas. Pose bébé sur le dos, nuque sur le bord replié, épaules légèrement en dessous.`,
      },
      {
        titre: 'Bras gauche',
      ...
      {
        titre: 'Le bas',
        texte: `Remonte le coin inférieur sur son ventre et replié-le. Les hanches doivent rester libres : ne serré jamais les jambes ensemble. Un emmaillotage trop serré dans les jambes peut provoquer une dysplasie de hanche.`,
      },
      {
      ...
      {
        titre: 'Quand arreter',
        texte: `Des que bébé montre des signes de retournément, vers 2 mois. Toujours sur le dos pour dormir emmailloté. Un bébé retourné sur le ventre emmailloté ne peut pas se repositionner.`,
      },
    ],
  ...
  },
  {
    ...
    etapes: [
      {
        titre: `Bebe s'étouffe - il tousse`,
      ...
      {
        titre: `Bebe s'étouffe - il ne tousse plus`,
        texte: `Tête en bas sur ton avant-bras. 5 tapes fermes entre les omoplates avec le talon de la main. Si insuffisant : retourné-le sur le dos, 2 doigts au centre de la poitrine, 5 compressions. Alterner jusqu'à libération ou secours.`,
      },
      {
        titre: 'Bebe ne répond plus',
      ...
      },
      {
        ...
        texte: `Avant 3 mois : toute fièvre au-dessus de 38 degrés = appel pédiatre ou urgences sans attendre. Entre 3 et 6 mois : appel medecin le jour même. Après 6 mois : surveiller l'etat general.`,
      },
    ],
