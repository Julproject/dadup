    ...
    etapes: [
      {
        ...
        texte: `Une bonne prise du sein se reconnaît à plusieurs signes : la bouche de bébé est grande ouverte et couvre une grande partie de l'aréole (pas seulement le mamelon), les lèvres sont retroussées vers l'extérieur, le menton appuie contre le sein, le nez est dégagé. On entend des déglutitions régulières. Si la douleur persiste au-delà des 30 premières secondes, c'est le signe d'une mauvaise prise. Glisse un doigt dans le coin de la bouche de bébé pour interrompre doucement la succion, puis repositionne. Recommencer n'est pas un échec.`,
      },
      {
        titre: "Les positions d'allaitement",
        texte: `La position en berceau est la plus courante : bébé est allongé face à sa mère, ventre contre ventre, sa tête dans le creux du coude. La position en ballon de rugby (bébé sous le bras, les pieds vers l'arrière) est souvent recommandée après une césarienne car elle évite d'appuyer sur la cicatrice. La position allongée sur le côté est pratique la nuit. Ce qui compte : bébé est bien face au sein et la maman est confortable.`,
      },
      {
        titre: 'Fréquence et durée',
        texte: `L'OMS recommande un allaitement à la demande, sans horaire imposé. Les premières semaines, bébé tète en général 8 à 12 fois par 24 heures. Il n'y a pas de durée fixe : certains bébés sont rassasiés en 10 minutes, d'autres prennent 40 minutes. Il est recommandé de laisser bébé finir un sein complètement avant de proposer l'autre, pour qu'il reçoive le lait de fin de tétée, plus riche en graisses.`,
      },
      {
        titre: 'La montée de lait',
        texte: `La montée de lait survient en général entre le 2e et le 4e jour après la naissance. Les seins deviennent chauds, lourds, parfois douloureux. C'est transitoire. Dans les premières heures, bébé reçoit du colostrum, un liquide épais très riche en anticorps, exactement adapté à ses besoins. La quantité paraît faible mais est suffisante. Il ne faut pas compléter avec un biberon sauf avis médical explicite.`,
      },
      {
    ...
    etapes: [
      {
        ...
        texte: `L'emmaillotage reproduit la sensation de contention ressentie in utero. Il peut apaiser certains bébés agités et faciliter l'endormissement en réduisant le réflexe de Moro (sursaut). Ce n'est pas une technique universelle : certains bébés y réagissent bien, d'autres pas du tout. À utiliser uniquement les premières semaines, pas comme habitude à long terme.`,
      },
      {
      ...
      },
      {
        ...
        texte: `Ne serre jamais les jambes de bébé ensemble dans l'emmaillotage. Les hanches doivent rester en position naturelle, légèrement fléchies et écartées comme celles d'une grenouille. Un emmaillotage trop serré dans les jambes augmente significativement le risque de dysplasie de hanche.`,
      },
      {
        titre: 'Quand arrêter',
        texte: `Arrête l'emmaillotage dès que bébé montre des signes de tentative de retournement, généralement vers 2 mois. Un bébé emmailloté qui se retourne sur le ventre ne peut pas se repositionner seul et risque l'étouffement. Bébé doit toujours dormir sur le dos.`,
      },
    ],
