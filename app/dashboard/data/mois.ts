...
export function getIdee(sa: number): string {
  const idees: Record<number, string> = {
    ...
    11: "11: "Son corps change vite. Un simple "tu es belle" sans rien ajouter vaut mieux que tous les compliments compliqués. Ces mots simples comptent vraiment.",
    ...
    23: "23: "Bébé commence à entendre ta voix clairement. Ce soir, pose ta main sur le ventre et parle-lui directement. Dis-lui ton prénom, une chose que tu attends avec impatience.",
    ...
    27: "27: "Elle est probablement fatiguée en fin de journée. Prends le relais du dîner cette semaine — même simple. Ce n'est pas la cuisine qui compte, c'est de ne pas avoir à y penser.",
    ...
    31: "31: "Prépare une playlist calme pour la salle de naissance. Quelques morceaux qu'elle aime. Ce détail compte le jour J.",
    32: "32: "Les nuits sont difficiles pour tout le monde en cette période. Propose-lui de gérer une nuit sur deux si vous pouvez. Le repos à deux s'organise avant la naissance.",
