  ...
  return (
    <main style={{minHeight:'100vh', background:C.cream, fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(max-width:768px){
          ...
          .echo-row{flex-direction:column!important;align-items:center!important;gap:24px!important;}
          .echo-phone{width:140px!important;height:290px!important;margin-top:-20px!important;}
          .echo-cta{text-align:center!important;width:100%!important;}
          .echo-cta button{width:100%!important;max-width:280px!important;margin:0 auto 12px!important;}
          .echo-cta h2{font-size:24px!important;}
          .echo-wrap{padding:20px 16px 48px!important;}
        }
      `}</style>
      ...
      <div style={{position:'relative'}}>
        ...
        <div className="echo-wrap" style={{background:'linear-gradient(135deg,#0a1f32 0%,#1A3D5C 50%,#1d4d72 100%)', padding:'0 40px 64px', position:'relative'}}>
          <div style={{position:'absolute', top:'-60px', right:'100px', width:'320px', height:'320px', borderRadius:'50%', background:'radial-gradient(circle,rgba(200,160,96,0.22) 0%,transparent 65%)', pointerEvents:'none'}}></div>
          <div style={{maxWidth:'960px', margin:'0 auto', display:'flex', alignItems:'center', gap:'56px', position:'relative', zIndex:1}}>
            ...
            <div style={{flexShrink:0, marginTop:'-40px', position:'relative', zIndex:2, animation:'float 4s ease-in-out infinite', transform:'rotate(-2deg)'}}>
              ...
              <div className="echo-phone" style={{width:'160px', height:'330px', background:'linear-gradient(160deg,#2c2c2e 0%,#1c1c1e 50%,#232323 100%)', borderRadius:'36px', padding:'6px', boxShadow:'0 40px 80px rgba(0,0,0,0.65),0 0 0 0.5px rgba(255,255,255,0.08),inset 0 0.5px 0 rgba(255,255,255,0.18)', position:'relative'}}>
            ...
            {/* CTA */}
            <div style={{flex:1}}>
              <h2 style={{color:'#fff', fontSize:'32px', fontWeight:800, margin:'0 0 4px', lineHeight:1.2}}>Maintenant tu sais.</h2>
              <h2 style={{color:'#e0b870', fontSize:'32px', fontWeight:800, margin:'0 0 28px', lineHeight:1.2}}>À toi de jouer</h2>
              <button onClick={() => setShowModal(true)} style={{background:'linear-gradient(135deg,#c8a060,#e8c070)', color:'#1c1510', border:'none', padding:'18px 48px', borderRadius:'32px', fontSize:'18px', fontWeight:800, cursor:'pointer', boxShadow:'0 8px 32px rgba(200,160,96,0.5)', display:'block', marginBottom:'12px'}}>
                Commencer
              </button>
              <p style={{color:'rgba(255,255,255,0.4)', fontSize:'13px', margin:0}}>Satisfait ou remboursé sous 14 jours</p>
            </div>
          </div>
        </div>
      </div>
