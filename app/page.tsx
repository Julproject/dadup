            ...
            {[
              {
                ...
                desc: "Chaque consultation expliquée. Ton rôle précis. Personnalisé à ta date d'accouchement.",
                svg: <svg width="40" height="40" viewBox="0 0 40 40"><rect width="40" height="40" rx="10" fill="#e8ddd4"/><rect x="10" y="8" width="20" height="24" rx="3" fill="none" stroke="#6b5c4e" strokeWidth="1.5"/><line x1="14" y1="14" x2="26" y2="14" stroke="#c8a882" strokeWidth="1.5" strokeLinecap="round"/><line x1="14" y1="18" x2="26" y2="18" stroke="#c8a882" strokeWidth="1" strokeLinecap="round"/><line x1="14" y1="22" x2="22" y2="22" stroke="#c8a882" strokeWidth="1" strokeLinecap="round"/></svg>
              },
              {
                titre: 'Suivi bébé semaine par semaine',
                desc: "Taille, poids, développement. Tu sais où en est bébé à chaque instant.",
                svg: <svg width="40" height="40" viewBox="0 0 40 40"><rect width="40" height="40" rx="10" fill="#e8ddd4"/><circle cx="20" cy="18" r="8" fill="none" stroke="#6b5c4e" strokeWidth="1.5"/><circle cx="20" cy="18" r="3" fill="#c8a882"/><path d="M20 10 L20 6 M20 30 L20 34 M10 18 L6 18 M30 18 L34 18" stroke="#c8a882" strokeWidth="1" strokeLinecap="round"/></svg>
              },
              {
                titre: 'Guide accouchement',
                desc: "Quand partir, ce que tu vas voir, comment soutenir sans être dans le chemin.",
                svg: <svg width="40" height="40" viewBox="0 0 40 40"><rect width="40" height="40" rx="10" fill="#e8ddd4"/><path d="M14 28 Q14 20 20 16 Q26 20 26 28" fill="none" stroke="#6b5c4e" strokeWidth="1.5" strokeLinecap="round"/><circle cx="20" cy="13" r="3" fill="none" stroke="#c8a882" strokeWidth="1.5"/><line x1="14" y1="28" x2="26" y2="28" stroke="#c8a882" strokeWidth="1.5" strokeLinecap="round"/></svg>
              },
              {
                titre: 'Valise maternité',
                desc: "Checklist interactive complète. Pour toi, pour elle, pour bébé. Rien n'est oublié.",
                svg: <svg width="40" height="40" viewBox="0 0 40 40"><rect width="40" height="40" rx="10" fill="#e8ddd4"/><rect x="12" y="14" width="16" height="18" rx="3" fill="none" stroke="#6b5c4e" strokeWidth="1.5"/><path d="M16 14 L16 11 Q20 8 24 11 L24 14" fill="none" stroke="#c8a882" strokeWidth="1.5" strokeLinecap="round"/><line x1="16" y1="20" x2="24" y2="20" stroke="#c8a882" strokeWidth="1" strokeLinecap="round"/><line x1="16" y1="24" x2="22" y2="24" stroke="#c8a882" strokeWidth="1" strokeLinecap="round"/></svg>
              },
              {
                titre: 'Post-partum décrypté',
                desc: "Baby blues, fatigue, couple. Comprendre ce qu'elle vit pour mieux l'accompagner.",
              ...
              {
                titre: 'Idées pour ta partenaire',
                desc: "Une idée chaque mois pour lui faire plaisir. Des attentions simples qui comptent vraiment.",
                svg: <svg width="40" height="40" viewBox="0 0 40 40"><rect width="40" height="40" rx="10" fill="#e8ddd4"/><path d="M20 30 L12 22 Q9 15 16 13 Q20 12 20 18 Q20 12 24 13 Q31 15 28 22 Z" fill="none" stroke="#c8a882" strokeWidth="1.5" strokeLinejoin="round"/></svg>
              },
              {
                titre: 'Survie premier mois',
                desc: "Emmaillotage, pleurs, sommeil, biberon. Les techniques qui marchent vraiment.",
                svg: <svg width="40" height="40" viewBox="0 0 40 40"><rect width="40" height="40" rx="10" fill="#e8ddd4"/><circle cx="20" cy="16" r="5" fill="none" stroke="#6b5c4e" strokeWidth="1.5"/><path d="M14 30 Q14 22 20 22 Q26 22 26 30" fill="none" stroke="#c8a882" strokeWidth="1.5" strokeLinecap="round"/></svg>
              },
              {
                titre: 'Liste achats prioritaires',
                desc: "Ce qui est vraiment nécessaire, dans quel ordre l'acheter, et pour quel budget.",
                svg: <svg width="40" height="40" viewBox="0 0 40 40"><rect width="40" height="40" rx="10" fill="#e8ddd4"/><circle cx="14" cy="20" r="2" fill="#c8a882"/><line x1="19" y1="20" x2="30" y2="20" stroke="#6b5c4e" strokeWidth="1.5" strokeLinecap="round"/><circle cx="14" cy="14" r="2" fill="#c8a882"/><line x1="19" y1="14" x2="30" y2="14" stroke="#6b5c4e" strokeWidth="1.5" strokeLinecap="round"/><circle cx="14" cy="26" r="2" fill="#c8a882"/><line x1="19" y1="26" x2="30" y2="26" stroke="#6b5c4e" strokeWidth="1.5" strokeLinecap="round"/></svg>
              },
            ].map((m, i) => (
