      ...
      <section style={{padding:'80px 0', background:'#f0ece6', overflow:'hidden'}}>
        ...
        <div className="auto-wrap">
          <div className="auto-track">
            {[
              {titre:"Les échographies", desc:"À quoi servent T1, T2, T3 ? Ce qu'on cherche, comment être vraiment présent.", bg:'#C8E8FF', color:'#0A2847', border:'rgba(46,95,138,0.2)'},
              {titre:"La valise maternité", desc:"Checklist interactive. Ce qu'elle emporte, ce que tu prends pour toi, ce que tout le monde oublie.", bg:'#B8F0D8', color:'#0A2E1A', border:'rgba(13,107,64,0.2)'},
              {titre:"L'accouchement", desc:"La règle 5-1-1. Quand partir. Ce que tu fais en salle de naissance.", bg:'#FFE8A0', color:'#3A2000', border:'rgba(200,160,96,0.3)'},
              {titre:"Le baby blues", desc:"50 à 80% des femmes le vivent. Ce que c'est, comment tu peux vraiment aider.", bg:'#DDD0FF', color:'#1A0A4A', border:'rgba(107,79,187,0.2)'},
              {titre:"Le congé paternité", desc:"28 jours. Comment les poser, ce que ça change vraiment pour votre famille.", bg:'#B8F0D8', color:'#0A2E1A', border:'rgba(13,107,64,0.2)'},
              {titre:"Le post-partum", desc:"Baby blues, reprise du travail, nuits sans sommeil. Ton rôle les premières semaines.", bg:'#C8E8FF', color:'#0A2847', border:'rgba(46,95,138,0.2)'},
              {titre:"Les échographies", desc:"À quoi servent T1, T2, T3 ? Ce qu'on cherche, comment être vraiment présent.", bg:'#C8E8FF', color:'#0A2847', border:'rgba(46,95,138,0.2)'},
              {titre:"La valise maternité", desc:"Checklist interactive. Ce qu'elle emporte, ce que tu prends pour toi, ce que tout le monde oublie.", bg:'#B8F0D8', color:'#0A2E1A', border:'rgba(13,107,64,0.2)'},
              {titre:"L'accouchement", desc:"La règle 5-1-1. Quand partir. Ce que tu fais en salle de naissance.", bg:'#FFE8A0', color:'#3A2000', border:'rgba(200,160,96,0.3)'},
              {titre:"Le baby blues", desc:"50 à 80% des femmes le vivent. Ce que c'est, comment tu peux vraiment aider.", bg:'#DDD0FF', color:'#1A0A4A', border:'rgba(107,79,187,0.2)'},
              ...
              <div key={i} className="auto-card" style={{background:item.bg, border:`1px solid ${item.border}`, boxShadow:'0 2px 12px rgba(0,0,0,0.06)'}}>
                ...
                <p style={{color:item.color, fontSize:'13px', lineHeight:1.65, margin:0, opacity:0.75}}>{item.desc}</p>
              </div>
            ))}
          </div>t CheckoutModal from '@/app/components/CheckoutModal';
import { useState } from 'react';
