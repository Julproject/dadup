    ...
    <main className="min-h-screen bg-[#f8f5f0]">
      ...
      <header className="bg-white border-b border-[#e8ddd4] px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        ...
        <button
          ...
          className="bg-[#3a3028] text-[#f0e0cc] text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-[#6b5c4e] transition-all"
        >
          Commencer — 19,99€
        </button>
      </header>
      ...
      <section className="max-w-2xl mx-auto px-6 pt-16 pb-12">
        <p className="text-[#c8a882] text-xs uppercase tracking-[4px] font-medium mb-6" style={{fontFamily:'sans-serif'}}>Le guide du père</p>
        <h1 className="text-5xl font-bold text-[#3a3028] leading-tight mb-6" style={{fontFamily:'Georgia,serif'}}>
          Papa,<br />
          dès le<br />
          <span className="text-[#c8a882]">premier jour.</span>
        </h1>
        <p className="text-[#6b5c4e] text-lg leading-relaxed mb-4 font-medium" style={{fontFamily:'Georgia,serif'}}>
          Tout ce qu'on ne t'a pas appris.
        </p>
        <p className="text-[#9a8470] text-base leading-relaxed mb-10" style={{fontFamily:'sans-serif'}}>
          De la première échographie au premier mois de vie. Un espace complet, personnalisé à ta date d'accouchement, conçu pour toi.
        </p>
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            onClick={() => setShowForm(true)}
            className="bg-[#3a3028] text-[#f0e0cc] font-bold px-8 py-4 rounded-full hover:bg-[#6b5c4e] transition-all text-sm tracking-wide"
          >
            Accès à vie — 19,99€
          </button>
          
            href="#contenu"
            className="border border-[#e8ddd4] text-[#9a8470] font-medium px-8 py-4 rounded-full hover:border-[#c8a882] transition-all text-sm text-center"
          >
            Voir le contenu
          </a>
        </div>
        <p className="text-[#b0988a] text-xs mt-4" style={{fontFamily:'sans-serif'}}>Accès immédiat. Paiement unique. Aucun abonnement.</p>
      </section>
        ...
        <div className="max-w-2xl mx-auto px-6 py-8 grid grid-cols-3 gap-4">
          {[
            ...
            <div key={s.label} className={`text-center ${i === 1 ? 'border-x border-[#e8ddd4]' : ''}`}>
              ...
              <p className="text-[#9a8470] text-xs mt-1" style={{fontFamily:'sans-serif'}}>{s.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-2xl mx-auto px-6 py-16">
        <p className="text-[#c8a882] text-xs uppercase tracking-[4px] font-medium mb-4" style={{fontFamily:'sans-serif'}}>Le constat</p>
        <h2 className="text-3xl font-bold text-[#3a3028] mb-8" style={{fontFamily:'Georgia,serif'}}>
          Tout le monde prépare la maman.<br />
          <span className="text-[#9a8470]">Et toi ?</span>
        </h2>
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="flex items-start gap-3">
              ...
              <p className="text-[#6b5c4e] text-base" style={{fontFamily:'sans-serif'}}>{t}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="contenu" className="bg-white border-t border-[#e8ddd4]">
        <div className="max-w-2xl mx-auto px-6 py-16">
          <p className="text-[#c8a882] text-xs uppercase tracking-[4px] font-medium mb-4" style={{fontFamily:'sans-serif'}}>Ce que tu obtiens</p>
          <h2 className="text-3xl font-bold text-[#3a3028] mb-10" style={{fontFamily:'Georgia,serif'}}>
            Tout ce qu'on ne t'a pas appris.
          </h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex gap-4 p-5 rounded-2xl border border-[#e8ddd4] hover:border-[#c8a882] transition-all bg-[#f8f5f0]">
                <div className="w-8 h-8 rounded-full bg-[#e8ddd4] flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-[#6b5c4e] text-sm font-bold" style={{fontFamily:'sans-serif'}}>{i + 1}</span>
                </div>
                <div>
                  <p className="text-[#3a3028] font-bold text-sm mb-1" style={{fontFamily:'sans-serif'}}>{m.titre}</p>
                  <p className="text-[#9a8470] text-sm leading-relaxed" style={{fontFamily:'sans-serif'}}>{m.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="max-w-2xl mx-auto px-6 py-16">
        <blockquote className="border-l-2 border-[#c8a882] pl-6">
          <p className="text-2xl font-bold text-[#3a3028] leading-relaxed" style={{fontFamily:'Georgia,serif'}}>
            "Papa, dès le premier jour."
          </p>
          <p className="text-[#9a8470] text-sm mt-3" style={{fontFamily:'sans-serif'}}>
      ...
      <section className="bg-[#3a3028]">
        <div className="max-w-2xl mx-auto px-6 py-16 text-center">
          <p className="text-[#c8a882] text-xs uppercase tracking-[4px] font-medium mb-4" style={{fontFamily:'sans-serif'}}>L'offre</p>
          ...
          <p className="text-[#6b5c4e] text-sm mb-8" style={{fontFamily:'sans-serif'}}>Paiement unique. Aucun abonnement. Accès immédiat.</p>
          <div className="space-y-3 text-left max-w-sm mx-auto mb-10">
            {[
              ...
              <div key={f} className="flex items-center gap-3">
                ...
                <p className="text-[#e8d5c4] text-sm" style={{fontFamily:'sans-serif'}}>{f}</p>
              </div>
            ))}
          </div>
          <button
            onClick={() => setShowForm(true)}
            className="bg-[#c8a882] hover:bg-[#b89060] text-[#1c1510] font-bold px-10 py-4 rounded-full transition-all text-sm tracking-wide"
          >
            Commencer maintenant — 19,99€
          </button>
          <p className="text-[#4a3c30] text-xs mt-4" style={{fontFamily:'sans-serif'}}>Paiement sécurisé par Stripe</p>
        </div>
      </section>

      {/* FOOTER */}
      <footer className="max-w-2xl mx-auto px-6 py-8 text-center">
        <p className="text-[#c8b8a8] text-xs leading-relaxed" style={{fontFamily:'sans-serif'}}>
          DadUp est un outil d'information et d'accompagnement. Il ne remplace pas l'avis d'un médecin ou d'une sage-femme.<br />
