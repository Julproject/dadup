          ...
          {(status === 'sent' || status === 'pending') && (
            <>
              ...
              <p style={{ color: '#4a5568', fontSize: '15px', lineHeight: 1.7, margin: '0 0 28px' }}>
                {status === 'sent'
                  ? "Ton accès est activé. Un email vient d'être envoyé avec un lien pour créer ton mot de passe."
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '32px', textAlign: 'left' }}>
                {[
                  { n: '1', texte: 'Vérifie ta boite mail (et tes spams)' },
          ...
          {status === 'error' && (
            <>
              ...
              <p style={{ color: '#4a5568', fontSize: '15px', lineHeight: 1.7, margin: '0 0 24px' }}>
                Ton paiement a bien été reçu. L'email d'activation peut prendre quelques minutes. Si tu ne le reçois pas, écris-nous.
              </p>
