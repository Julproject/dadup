...
const TEMOIGNAGES = [
  ...
  {prenom:'Antoine', age:35, ville:'Bordeaux', semaine:'SA 20', texte:"29 euros pour tout ça, c'est franchement honnête. J'aurais dépensé dix fois plus en livres que je n'aurais jamais finis. DadUp c'est pratique, personnalisé, et je l'ai sur mon téléphone à tout moment.", dark:false},
  ...
  {prenom:'Nicolas', age:30, ville:'Toulouse', semaine:'SA 40', texte:"Bébé est arrivé. Je voulais juste dire merci. Le guide accouchement m'a donné confiance. J'étais là, vraiment présent, du début à la fin. C'est le plus beau jour de ma vie.", dark:false},
];
    ...
    <main style={{minHeight:'100vh', background:C.white, fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>
      ...
      <section style={{background:C.dark,padding:'80px 40px'}}>
        <div style={{maxWidth:'800px',margin:'0 auto',textAlign:'center'}}>
          <p style={{color:C.blue,fontSize:'11px',fontWeight:700,letterSpacing:'3px',textTransform:'uppercase',margin:'0 0 16px'}}>Témoignages</p>
      ...
      <section className="sp" style={{padding:'80px 40px',maxWidth:'1200px',margin:'0 auto'}}>
        <div className="cta-inner" style={{background:C.dark,borderRadius:'28px',padding:'64px',textAlign:'center' as const}}>
          ...
          <p style={{color:'#6a7585',fontSize:'16px',margin:'0 0 40px'}}>29,99€/an. Sans engagement. Accès immédiat.</p>
          ...
          <p style={{color:'#3d5070',fontSize:'12px',margin:'16px 0 0'}}>Paiement sécurisé par Stripe</p>
        </div>
      </section>
